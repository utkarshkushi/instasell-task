...
const TimeLineTabs = (props: Props) => {
  ...
  return (
    <div className='flex gap-3 mt-8'>
                ...
                <div onClick={() => setTimeLinetab(5)} className={`flex justify-center items-center p-3 rounded-md cursor-pointer ${timelineTab == 5 ? (`bg-violet border-2 border-[#8051FF] bg-[#F8F7FF]`) : (`bg-white`)}`}>
